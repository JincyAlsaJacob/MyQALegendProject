...
public class ResetPageTest extends Base {
	...
	public void verifyResetPassword() {
		...
		String expected_message = ExcelUtility.getStringData(0, 1, Constants.RESET_PAGE);
		Assert.assertEquals(actual_message, expected_message, Messages.INVALID_MAILID);
	...
	public void verifyErrorMessageWithInvalidEmailidOnForgotPassword() {
		...
		String expected_errormessage = ExcelUtility.getStringData(2, 1, Constants.RESET_PAGE);
		Assert.assertEquals(actual_errormessage, expected_errormessage, Messages.VALID_MAILID);
